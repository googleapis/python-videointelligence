...
AnnotateVideoRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      input_uri:
          ...
          which must be specified in the following format: ``gs
          ://bucket-id/object-id`` (other URI formats return [google.rpc
          .Code.INVALID_ARGUMENT][google.rpc.Code.INVALID_ARGUMENT]).
...
TimestampedObject = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "google.cloud.videointelligence_v1p3beta1.proto.video_intelligence_pb2",
        "__doc__": """For tracking related features. An object at time_offset
...
StreamingStorageConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      annotation_result_storage_directory:
          ...
          proto. URIs must be specified in the following format: ``gs
          ://bucket-id/object-id`` ``bucket-id`` should be a valid GCS
          bucket created by client and bucket permission shall also be
          configured properly. ``object-id`` can be arbitrary string
